...
public class Product_Edit_Controller implements Initializable {
    ...
    @FXML
    public ComboBox fournisseur_cambo;
    ...
    public boolean istextFieldsNotEmpty(){
        if(
                !ref_txt.getText().isEmpty() &&
                        ...
                        !fournisseur_cambo.getValue().toString().isEmpty() &&
        ...
        if (istextFieldsNotEmpty()) {
            ...
            try{
                ...
                String query  = "UPDATE demo.product_table SET ref =?, des =?, nbr_pcs_crt =? , quan =? , nbr_pcs =?" +
                        " , code_bare =? , alert =? , expiration =? , prix_achat =? , prix_vent =? , personID = ? , date_entre= ? Where id="+Id;
    ...
    public void clear(){
        ...
        quant_txt.clear();
        code_bare_txt.clear();
        fournisseur_cambo.setValue(null);
        alert_txt.clear();
    ...
    public  void loadData() throws SQLException {
        ...
        try{
            ...
            while(rs.next()){
                ...
                fournisseur_cambo.getItems().add(rs.getString("name"));
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        fournisseur_cambo.setValue(FOURNISSEUR);
